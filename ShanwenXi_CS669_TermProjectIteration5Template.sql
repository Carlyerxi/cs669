...
#I'd like to use my structure instead of above list since I'm following my step to step creation
#All the additional insert data has been clarified and was created when the query need
